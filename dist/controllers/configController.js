...
var Config = models_1.models.Config;
var getAllConfigs = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var configs, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Config.findAll()];
            case 1:
                configs = _a.sent();
                res.json(configs);
                return [3 /*break*/, 3];
...
var getConfigById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var config, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Config.findByPk(req.params.id)];
            case 1:
                config = _a.sent();
                if (config) {
                    res.json(config);
...
var createConfig = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Config.create(req.body)];
            case 1:
                config = _a.sent();
...
var updateConfig = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var updated, updatedConfig, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, Config.update(req.body, {
